...
update_info_cust = Customer("Changed by", "update customer.", 8)
...
def test_get_customer_information_happy():
    ...
    customer_info = postgres_customer_dao.get_customer_information(3)
    assert customer_info.customer_id == 3
...
def test_delete_customer_happy():
    deleted_customer = postgres_customer_dao.delete_customer(6)
