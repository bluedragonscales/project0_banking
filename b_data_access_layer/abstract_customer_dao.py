...
class CustomerDAO(ABC):
    ...
    # The abstract method to create a customer. We pass in the whole customer object so we have access to all the info
    # for that customer. The return type is also the whole object.
    @abstractmethod
